...
\column{0.45\textwidth}
\begin{figure}
\includegraphics[width=1\textwidth]{graphics/scatter-with-chitest}
\end{figure}
\column{0.45\textwidth}
\begin{figure}
\includegraphics[width=1\textwidth]{../abx_software/webMUSHRA_c929877_20180814/configs/boxplot_time}
\end{figure}
\end{columns}
\end{frame}
%
...
detection of phase shift against original:
\begin{itemize}
...
\date{This project fully supports open science: https://doi.org/10.5281/zenodo.\textcolor{colnonzero}{3383286}}
\maketitle
%
%
%
